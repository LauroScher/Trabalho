...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void initState() {
    super.initState();
    final defaultListenerNotifier = DefaultListenerNotifier(changeNotifier: context.read<RegisterController>());
                ...
                children: [
                  ...
                  TodoListField(
                    ...
                    validator: Validatorless.multiple([
                      ...
                      Validators.compare(_passwordEC, 'Senha diferente, confirme sua senha!'),
                    ]),
                  ),
                  const SizedBox(
                    height: 20,
